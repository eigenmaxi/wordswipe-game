...
const App = () => {
  ...
  const isValidEnglishWord = (word) => {
    ...
    const validWords = new Set([
      ...
      // Additional common words that should be recognized
      'AMAZING', 'BEAUTY', 'BRAVE', 'CHARM', 'DREAM', 'ELEGANT', 'FREEDOM', 'GENTLE', 'HEROIC', 'INSPIRE',
      'JUSTICE', 'KINDLY', 'LOYAL', 'MAGIC', 'NOBLE', 'OPTIMISTIC', 'PASSION', 'QUIET', 'RESPECT', 'SERENE',
      'TRUST', 'UNITY', 'VIBRANT', 'WISDOM', 'YOUTH', 'ZEALOUS', 'ACCEPT', 'BELIEVE', 'CREATE', 'DEFINE',
      'EXPRESS', 'FORGIVE', 'GUIDE', 'HONOR', 'IMAGINE', 'JOURNEY', 'KNOWLEDGE', 'LEAD', 'MOTIVATE', 'NAVIGATE',
      'ORGANIZE', 'PREPARE', 'QUALIFY', 'REFLECT', 'SUPPORT', 'TRANSCEND', 'UNDERSTAND', 'VALIDATE', 'WITNESS', 'YIELD',
      'ZERO', 'ABSORB', 'BUILD', 'CHALLENGE', 'DEVELOP', 'EXPAND', 'FOCUS', 'GENERATE', 'HIGHLIGHT', 'INITIATE',
      'JOIN', 'KICKSTART', 'LEVERAGE', 'MASTER', 'NETWORK', 'OPTIMIZE', 'PRIORITIZE', 'QUESTION', 'RENEW', 'STRENGTHEN',
      'TRANSFORM', 'UPGRADE', 'VISION', 'WORK', 'EXCEL', 'FLY', 'GROW', 'HAPPEN', 'INNOVATE', 'LEARN',
      'MOVE', 'NOTICE', 'OPEN', 'PLAN', 'QUICKEN', 'REALIZE', 'SEEK', 'THINK', 'UNDERGO', 'VALUE',
      'WISH', 'YES', 'ZOOM', 'ACT', 'BE', 'COME', 'DO', 'END', 'FIND', 'GO', 'HAVE', 'MAKE',
      'SEE', 'TAKE', 'USE', 'WANT', 'WORK', 'YEAR', 'ZONE', 'AGE', 'BAD', 'CAN', 'DID', 'EAT', 'FAR',
      'GET', 'HIM', 'ITS', 'JOB', 'KEY', 'LAW', 'MAN', 'NOW', 'OFF', 'PUT', 'RED', 'SAY',
      'TRY', 'UP', 'WAY', 'YES', 'ZOO', 'ALL', 'BIG', 'DAY', 'EYE', 'FAR', 'GOD', 'HOW',
      'ILL', 'JAN', 'KID', 'LIE', 'MAY', 'NEW', 'OLD', 'PEN', 'QTY', 'RAT', 'SIR', 'TOP',
      'USA', 'VAT', 'WAR', 'YES', 'ZAP', 'ACE', 'BAT', 'COW', 'DAD', 'EGG', 'FOX', 'GUN',
      'HAT', 'ICE', 'JAM', 'KIN', 'LIP', 'MUD', 'NET', 'OAK', 'PIE', 'RUG', 'SUN', 'TIE',
      'URN', 'VAN', 'WAX', 'YAK', 'ZIP', 'ASH', 'BEE', 'CAT', 'DIE', 'ELF', 'FRO', 'GEM',
      'HOT', 'INK', 'JUG', 'KIT', 'LOG', 'MUG', 'NUN', 'OWL', 'PUB', 'RIB', 'SOAP', 'TREK',
      'UNIT', 'VOTE', 'WOLF', 'YARD', 'ZONE', 'ALPHA', 'BRAVO', 'CHARLIE', 'DELTA', 'ECHO', 'FOXTROT',
